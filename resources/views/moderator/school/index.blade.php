...
@section('content')
    ...
    <section class="sidebar-wrapper">
        <div class="title-wrapper">
            ...
            <a href="/moderator/schools/create" class="addschool-button"><span>Добавить</span> +</a>
        </div>
    ...
    <section class="table-wrapper">
        <div class="table">
            ...
            @foreach($schools as $school)
                <ul class="table-row">
                    <li>
                        <a href="/moderator/schools/{{ $school->uuid }}/reviews" class="link-in">
                            {{ $school->title }} {{-- исправил 25.02.2022 --}}
                        </a>
                    </li>
                    <li>
                        {{ $school->address }}
                    ...
                    <li>
                        <div class="action-zone">
                            <a href="/moderator/schools/{{ $school->uuid }}/edit" class="qr-button-action">
