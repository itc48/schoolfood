        ...
        <form action="/admin/users" method="POST" class="create-form">
            <fieldset>
                ...
                <label for="district-name">Имя <i>*</i><br/><br/>
                    <input type="text" name="name" placeholder="Название" id="district-name" required>
                </label><br><br>

                <label>Пароль <i>*</i><br/><br/>
                    <input type="password" name="password" placeholder="Пароль" id="district-name" required>
                </label><br><br>
